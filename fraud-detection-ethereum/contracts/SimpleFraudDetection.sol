...
contract SimpleFraudDetection {
    ...
    event TransactionRecorded(uint256 indexed id, bytes32 dataHash, bool isFraudulent);
    ...
    function recordTransaction(bytes32 _dataHash, bool _isFraudulent) public {
        transactionCount++;
        ...
        emit TransactionRecorded(transactionCount, _dataHash, _isFraudulent);
    }
